        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('skill_students.index') }}" method="POST" style="background-color:#F8F9F8">
                        @csrf

                        <div class="form-group mb-12">
                        <label for="">SKILL STUDENT</label><br>
                        ...
                        <div class="error"><br><lable style="background-color:#25F9DC">  &#8226; Select Student</lable></div>
                        @endif <br>
                        ...
                        <option value="{{ $skill_faculty->id }}">{{ $skill_faculty->faculties->name }} || {{ $skill_faculty->skill_courses->name }}</option>
                        @endforeach
                        </select></div>
                        @if($errors->has('skill_faculty'))
                        <div class="error"><br><lable style="color:red" >  &#8226; <u><b>Select Skill  </u></b></lable></div>
                        @endif <br>

                        <div class="form-group mb-12">
                        <label for="">SKILL COURSE</label><br>
	                    <select class="form-control"  name="skill_courses_id" id="skill_courses_id" >
                        ...
                        <div class="error"><br><lable style="color:red" >  &#8226; <u><b>Select Skill Course </u></b></lable></div>
                        @endif <br>
                        ...
                        <div class="error"><br><lable style="color:red" >  &#8226; <u><b>Enter Skill Student Status</u></b></lable></div>
                        @endif <br>
