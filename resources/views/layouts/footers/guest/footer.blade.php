    ...
    <div class="container">
      ...
      @if (!auth()->user() || \Request::is('static-sign-up'))
          <div class="col-lg-8 mx-auto text-center mb-4 mt-2">
              <a href="https://bitsathy.ac.in" target="_blank" class="text-secondary me-xl-4 me-4">
                  <span class="text-lg fab fa-dribbble" aria-hidden="true"></span>
              </a>
              <a href="https://twitter.com/bitsathyindia" target="_blank" class="text-secondary me-xl-4 me-4">
                  <span class="text-lg fab fa-twitter" aria-hidden="true"></span>
              </a>
              <a href="https://www.instagram.com/lifeatbit" target="_blank" class="text-secondary me-xl-4 me-4">
              ...
              <a href="https://git.bitsathy.ac.in" target="_blank" class="text-secondary me-xl-4 me-4">
        ...
        <div class="row">
          <div class="col-8 mx-auto text-center mt-1">
            <p class="mb-0 text-secondary">
              ...
              <a style="color: #252f40;" href="https://www.bitsathy.ac.in" class="mb-0 text-secondary" target="_blank">BIT
              -
             IT OPERATIONS  </a>.
            </p>
          </div>
